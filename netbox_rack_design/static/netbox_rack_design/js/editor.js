 ...
 */
// The read-model, the invariant checks and the placement authority live in
// their own module now (see editor/model.js). Resolved through the import map
// the editor template emits, so the URL carries the same ?v=<asset_version>
// cache-bust token every other editor asset gets -- a bare relative import
// could not, and a stale model.js against a fresh editor.js is a broken editor.
import {
    fullDepthDeviceIds,
    rdBuildModel,
    rdCheckInvariants,
