"""
Utility functions for testing NetBox Rack Design.
...
def create_test_user(username: str | None = None, permissions: list[str | None] = None,
    ...
    Example:
        ...
        ...     permissions=['netbox_rack_design.view_rackdesign']
        ... )
    """
    if username is None:
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Rackdesign.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Rackdesign': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Rackdesign.objects.create(name='Test')
